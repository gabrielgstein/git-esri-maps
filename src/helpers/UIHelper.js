...
export default class UIHelper {
    ...
    static getIcon(iconName, props) {

        switch (iconName) {

            case 'Ruler':
                return (
                    <svg style={{width: '24px', height: '24px'}} viewBox="0 0 24 24" {...props}>
            ...
            case 'MultiFilter':
                return (
                    <svg style={{width: '24px', height: '24px'}} viewBox="0 0 24 24" {...props}>
                        <path d="M10.2 13.5V21.4C10.3 21.7 10.2 22 9.9 22.2 9.5 22.6 8.9 22.6 8.5 22.2L6.5 20.2C6.3 20 6.2 19.7 6.2 19.4V13.5H6.2L0.4 6.1C0.1 5.7 0.2 5.1 0.6 4.7 0.8 4.6 1 4.5 1.2 4.5V4.5H15.2V4.5C15.4 4.5 15.6 4.6 15.8 4.7 16.3 5.1 16.3 5.7 16 6.1L10.2 13.5H10.2z"/><path d="M16.6 8.5V16.4C16.6 16.7 16.5 17 16.3 17.2 15.9 17.6 15.3 17.6 14.9 17.2L12.9 15.2C12.6 15 12.5 14.7 12.6 14.4V8.5H12.5L6.8 1.1C6.4 0.7 6.5 0.1 7-0.3 7.1-0.4 7.4-0.5 7.6-0.5V-0.5H21.6V-0.5C21.8-0.5 22-0.4 22.2-0.3 22.6 0.1 22.7 0.7 22.4 1.1L16.6 8.5H16.6z"/>
                    </svg>
                );
            case 'Filter':
                return (
            ...
            default:
                const IconClass = MaterialIcons[iconName];
                if (IconClass) {
    ...
    static getLegendSymbol({shape, color, borderWidth, borderColor, style}, className) {
